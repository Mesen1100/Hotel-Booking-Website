...
import realbabyIcon from '../../../assets/icons/8665382_child_kid_icon (1).png';
...
const GuestDetailChild:React.FC<Props>=({childAge,key,isSubmitting,setSubmitting,index,updateGuest}) =>{
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    required
                    fullWidth
                    id={ReservationPage.passportSerialError}
...
export default GuestDetailChild;
